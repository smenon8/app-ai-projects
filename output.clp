...
(defrule dispOutputWelcome
    ...
    ?p1 <- (fatLevel {personName == p.personName})
   	=>
    (printout t crlf crlf "*******************************WELCOME TO PERSONAL FITNESS ASSISTANT EXPERT SYSTEM****************************************************************" crlf)
    ...
    (printout t "Based on your BMI you have been categorized as " ?p1.FatLevelDesc crlf crlf)
